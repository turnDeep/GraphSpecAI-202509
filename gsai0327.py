...
def main():
    ...
    # データセットサイズに基づいて次元を調整
    if len(train_ids) > 100000:
        hidden_channels = 24  # 非常に大きなデータセット用に縮小
    else:
        hidden_channels = 32  # 通常サイズのデータセット用
        
    out_channels = MAX_MZ
    
    # 大規模データセット用にキャッシュ管理を強化
    def limit_memory_usage(percent=85):
